<?php
  ...
  ?>
<div class="col-md-12">
  <h1 class="page-header text-capitalize">Gasto x Engajamento<br>
...
<div class="col-md-12">
  <form name="form" id="form" method="get" action="">
    <input type="hidden" name="tipo" id="tipo"  value="gasto_engajamento">
    <div class="row">
      <!--<div class="col-md-4">
...
<table  class="table table-bordered table-hover highchart" data-graph-container-before="1" data-graph-type="column">
  ...
  <tbody>
    <?php  
      ...
      foreach($to_array as $rows){
       ...
       foreach($array as $row){
           if($row['action_type'] == 'post_engagement'){
               $post_engagement .= $row['value'];    
           }
       }
    ...
    <tr>
      ...
      <td><?php echo $post_engagement;?> </td>
      <!--<td><?php echo regra_tres($total_geral,$post_engagement);?> %</td>-->                
    </tr>
    <?php } ?>
  </tbody>
</table>
