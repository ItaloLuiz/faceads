<?php
  ...
  ?>
<div class="col-md-12">
  <h1 class="page-header text-capitalize">Gasto x Reações<br>
...
<table  class="table table-bordered table-hover highchart" data-graph-container-before="1" data-graph-type="column">
  ...
  <tbody>
    <?php  
      ...
      // echo '<pre>';
       ...
       foreach($array as $row){
           if($row['action_type'] == 'post_reaction'){
               $post_reaction .= $row['value'];    
           }else{
    ...
    <tr>
      ...
      <td><?php echo $post_reaction;?> </td>
      <!--<td><?php echo regra_tres($total_geral,$post_reaction);?> %</td>-->                
    </tr>
    <?php } ?>
  </tbody>
</table>
