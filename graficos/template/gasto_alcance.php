<?php
  ...
  $sql = "SELECT sum(spend) AS gasto, sum(reach) AS alcance, nome_unidade As unidade
   FROM tbl_log_ads
  ...
  ?>
<div class="col-md-12">
  <h1 class="page-header text-capitalize">Gasto x Alcance<br>
...
<div class="col-md-12">
  <form name="form" id="form" method="get" action="">
    <input type="hidden" name="tipo" id="tipo"  value="gasto_alcance">
    <div class="row">
      <!--<div class="col-md-4">
