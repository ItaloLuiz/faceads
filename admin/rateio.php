                      ...
                      <div class="form-group">
                        ...
                        <select multiple name="unidades[]" id="unidades" class="form-control demo2" required="required">
                          <?php 
                            ...
                            ?>
                          <option <?php echo $selected2;?>  value="<?php echo $account_id;?>"><?php echo $nome_unidade;?></option>
                          <?php } ?>
                        </select>
                      </div>
                    </div>
    ...
    <script>
      $(document).ready(function(){
          $('#campanha').change(function(){
              ...
              var novoLink = 'rateio.php?camp='+campanha+"&id=<?php echo $_GET['id'];?>&N=<?php echo $_GET['N'];?>&dt_ini=<?php echo $_GET['dt_ini'];?>";             
              window.location.href = novoLink;              
          });
      });    
    </script>
