        ...
        <div class="row">
          <div class="col-md-12">
            <div class="box box-primary">
              ...
              <div class="box-body">
                <form name="form" id="form" action="index.php" method="post" role="form" novalidate>
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select  name="campanha" id="campanha" class="form-control" required="required">
                          <?php
                            $pega_Campanha = file_get_contents(''.$url_base.'listCamp.php');
                    ...
                    <?php if(isset($_GET['camp'])){
                      ...
                      $get_campanha = file_get_contents(''.$url_base.'/detalhaCamp.php?id='.$pega_id.'');
                      ...
                      <div class="form-group">
                        ...
                        <select multiple name="unidades[]" id="unidades" class="form-control demo2" required="required">
                          <?php 
                            ...
                            $url = file_get_contents(''.$url_base.'admNew/getUnidades.php');
    ...
    <script>
      $(document).ready(function(){
          $('#campanha').change(function(){
              ...
              var novoLink = 'index.php?camp='+campanha;             
              window.location.href = novoLink;
      ...
      $(document).ready(function(){
       ...
       $('.demo2').change(function(){
        ...
        $('#form').submit(function(){
          ...
          $.post('salva_banco.php',{cod_campanha:cod_campanha,dados:dados,total_gasto:total_gasto,alcance_camp:alcance_camp,ratio_camp:ratio_camp,data_inicio:data_inicio,data_final:data_final},function(data){
            $('#resposta').html(data);
          });
        });     
